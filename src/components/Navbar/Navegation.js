      ...
      <Navbar bg="dark" variant="dark">
        <Container>
          ...
          <Nav className="me-auto">
            ...
            <Nav.Item>
              <Link className="nav-link text-light" to="/categories/Action">
                Action
              </Link>
            </Nav.Item>

            <Nav.Item>
              <Link className="nav-link text-light" to="/categories/Adventure">
                Adventure
              </Link>
            </Nav.Item>

            <Nav.Item>
              <Link className="nav-link text-light" to="/categories/Drama">
                Drama
              </Link>
            </Nav.Item>

            <Nav.Item>
              <Link className="nav-link text-light" to="/categories/Thriller">
                Thriller
              </Link>
            </Nav.Item>
          </Nav>
